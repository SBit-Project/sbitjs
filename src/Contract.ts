...
const log = debug("sbitjs:contract")

const { logDecoder } = require("sbitjs-ethjs-abi") as IETHABI
...
export class Contract {
   ...
   *      [solar](https://github.com/SBit-Project-Project/solar). It includes the contract
  ...
  /**
   * Executes contract method on your own local sbitd node as a "simulation"
